# data.gd
# The player's stored setting overrides. Construct with a schema, then call
# load_saved() to pull in anything previously written to disk.
extends RefCounted
...
# SAVE/LOAD
#================================================================================#
# Loads the player's saved overrides into this instance. A missing file is not
# an error — it just means nothing has been changed from defaults yet.
func load_saved() -> void:
	if FileAccess.file_exists(AddonPaths.SAVE_PATH):
		_read()
