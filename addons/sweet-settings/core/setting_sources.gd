...
static func _inject_section_sources(schema: SettingsSchema) -> void:
	for section in schema.sections:
		match str(section.get("settings_source", "")):
			...
			_:
				push_warning(
					"Sweet Settings: unknown settings_source '%s' on section '%s'."
...
static func _options_for(source: String) -> Array[Dictionary]:
	match source:
		...
		_:
			push_warning("Sweet Settings: unknown options_source '%s'." % source)
			return []
...
static func _default_for(source: String, setting: Dictionary) -> Variant:
	match source:
		...
		_:
			push_warning("Sweet Settings: unknown default_source '%s'." % source)
			return null
#================================================================================#
